...
require 'test_helper'
require 'generators/webhookr/shopkeep/init_generator'

class InitGeneratorTests < Rails::Generators::TestCase
  tests Webhookr::Shopkeep::Generators::InitGenerator
  ...
  test "it should have authorization information" do
    assert_file @initializer do |content|
      assert_match(%r{Webhookr::Shopkeep::Adapter\.config\.security_token}, content)
    end
  end
end