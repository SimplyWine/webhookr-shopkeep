...
describe Webhookr::Shopkeep::Adapter do
  ...
  describe "the class" do
    ...
    subject { Webhookr::Shopkeep::Adapter }
  ...
  describe "the instance" do
    ...
    subject { Webhookr::Shopkeep::Adapter.new }
  ...
  describe "it's response" do
    before do
      @event_type = "unsubscribe"
      @adapter = Webhookr::Shopkeep::Adapter.new
    end
    ...
    it "should return the correct service name" do
      assert_equal(Webhookr::Shopkeep::Adapter::SERVICE_NAME, subject.service_name)
    end
